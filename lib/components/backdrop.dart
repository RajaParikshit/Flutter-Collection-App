...
class _BackdropTitle extends AnimatedWidget {
  final VoidCallback onFrontIconPressed;
    ...
    return DefaultTextStyle(
      ...
      child: Row(children: <Widget>[
        ...
        SizedBox(
          width: 72.0,
          child: IconButton(
            onPressed: this.onFrontIconPressed,
  ...
  Widget build(BuildContext context) {
    var appBar = AppBar(
      ...
      title: _BackdropTitle(
        ...
        onFrontIconPressed: widget.onFrontIconPressed,
      ),
